<template>
    <div class="formulario-container">
      <div class="formulario">
        ...
        <button @click="enviarTituloYEvento" class="boton-enviar">Enviar</button>
      </div>
    ...
    methods: {
      async enviarTituloYEvento() {
        try {
          ...
          if (error) {
            console.error('Error al enviar título y evento:', error.message);
          } else {
            console.log('Título y evento enviados correctamente:', data);
